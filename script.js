...
hope = new Audio('https://jmp.sh/s/smBvBzk5oe5xfTOTA8Pg');
...
$('body').on('click', '.tw', () => {
    twShare(`https://undersalmlon.github.io/SoulHealing`, `Hãy cùng mình cảm nhận bài thơ này nhé "${poems[index].title}" bởi ${poems[index].poet} tại Campaign for Soul Healing. https://undersalmlon.github.io/SoulHealing${index} %23CampaignforSoulHealing`, 520, 350);
    return false;
});
